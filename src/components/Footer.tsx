  ...
  return (
    <footer className="bg-foreground/5 border-t border-tertiary/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm text-foreground/80">
              Periodista, escritor y docente venezolano/mexicano. Colaborador en medios internacionales.
            </p>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold text-accent mb-4">Enlaces</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-accent mb-4">Redes Sociales</h3>
        ...
        <div className="mt-8 pt-8 border-t border-tertiary/20 text-center">
          <p className="text-sm text-foreground/60">
            © {new Date().getFullYear()} Rubén Machaen. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
